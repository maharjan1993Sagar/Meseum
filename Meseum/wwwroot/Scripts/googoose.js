...
//            margins: '1cm',
//            zoom: '100',
//            filename: 'Report' + now.getDate()+'/'+parseInt(now.getMonth()+1)+'/'+now.getFullYear() + '.doc',
//            size: '11.69in 8.26in',
//            display: 'Print',
//            lang: 'en-US',
//            charset:'utf-8',
...
//                var hdrftr = $('<table id=\'' + options.headerfooterid + '\' cellpadding="0"></table>');
...
//            html += '\tmargin:1in 0in 0in 0.5in;\n';
//            html += '}\n';
//            html += '-->\n';
//            html += ('#' + options.headerfooterid + ' tr{\n');
//            html += '\tpadding:1px;\n';
//            html += '}\n';
//            html += '-->\n';
//            html += '</style>\n';
